    ...
    class RepairManagement {
        ...
        private $db;
            ...
            public function __construct() {
                // เพิ่มการ require Database class
        ...
        public function getRepairsByTechnician($technician_id) {
            try {
                $stmt = $this->conn->prepare("
                    SELECT r.*, 
                        p.brand_name, p.models,
                    ...
                    LEFT JOIN psd_users u1 ON r.user1 = u1.user_id
                    LEFT JOIN department d ON p.dept_id = d.dept_id
                    WHERE r.technician = :technician_id
                    ORDER BY r.date_1 DESC
                ");
                ...
                error_log("Error getting technician repairs: " . $e->getMessage());
                return [];
            }
        }
        ...
        public function getRepairStatistics() {
            try {
                ...
                $avgRepairTime = $result['avg_repair_time'];
                $stats['avg_repair_time'] = $avgRepairTime === null ? 0 : round($avgRepairTime, 1);
                return $stats;
                } catch(PDOException $e) {
                    return [];
                }
